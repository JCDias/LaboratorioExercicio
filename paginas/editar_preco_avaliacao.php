<?php 
	...
	$mens = mysql_fetch_array(mysql_query("SELECT * FROM `preco_avaliacao` JOIN categorias ON categoria_fk = id_categoria where id_preco_avaliacao=$id;",$db));
	//Selecionar dados da mensalidade escolhida
...
<div>
    <ul class="breadcrumb">
		...
		<li>
            <a href="editar_mens.php">Editar Preço Avaliação Física</a>
        </li>
    </ul>
</div>
<!-- Fim breadcrumb -->
    ...
    <div class="box col-md-4">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i> Editar Preço Avaliação Física</h2>
            </div>
            <div class="box-content">
                <div class="control-group">
					<form action="cadastar_preco_avaliacao.php" method="POST" name="cad_preco_mens">
						...
						<input type="hidden" name="id" value="<?php echo $mens['id_preco_avaliacao']?>" />
