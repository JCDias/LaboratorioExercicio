 ...
 */
define("DB_USER", 'root');
define("DB_PASSWORD", '2863');
define("DB_NAME", 'laboratorio');
define("DB_HOST", 'localhost');
define("OUTPUT_DIR", 'D:\Backup');
define("TABLES", 'login, categorias, usuarios, frequencia, responsavel, preco_diaria, preco_mensalidade, caixa, data_mensalidade, mensalidade, preco_avaliacao, preco_reavaliacao');
// define("TABLES",'*');
    ...
    public function backupTables($tables = '*', $outputDir = '.')
    {
        try
        {
            ...
            */
			...
			//$tables = array('login','usuarios','mensalidade');
            ...
            * Iterate tables
            */
			echo '<p><b>Backup iniciado!</b></p><hr/>';
            foreach($tables as $table)
            {
                echo "Fazendo backup da tabela ".$table."...<br/>";
