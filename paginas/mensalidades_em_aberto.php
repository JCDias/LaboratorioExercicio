...
<?php
	...
	$sql = "select data_vencimento, id_mensalidade, usuario_fk, nome, date_format(data_vencimento,'%d-%m-%Y'), valor_a_receber, desconto_a_receber, usuarios.categoria_fk from mensalidade join usuarios on usuario_fk = id_usuario where data_vencimento<=curdate() and status_pagamento = 'em aberto' order by data_vencimento;";
...
<div class="row">
	...
	<?php }else{
				echo 'Nenhuma mensalidade em vencida!<br/><br/>';
			}?>
    </div>
    </div>
    </div>
