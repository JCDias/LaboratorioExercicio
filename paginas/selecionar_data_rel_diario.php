...
<script>
	function relatorio(){
		...
		var pagina = 'relatorios/relatorio_diario.php?turno='+turno;
			...
			<div class="control-group">
					<form action="" method="POST">
						<div class="form-group">
							<label>Data:</label>
							<input type="text" name="inicio" id="inicio" class="form-control calendario" required  value="<?php echo $date?>" disabled />
						</div>
						<div class="form-group">
						<label>Turno:</label>
								<select name="turno" id="turno" data-rel="chosen" required>
									<option value="1">Matutino</option>
									<option value="2">Vespertino e Noturno</option>
